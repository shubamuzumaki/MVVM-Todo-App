...
class AddEditTaskViewModel @ViewModelInject constructor(
    ...
    private fun showInvalidInputMessage(invalidMsg: String) = viewModelScope.launch {
        addEditTaskChannel.send(AddEditTaskEvent.ShowInvalidInputMessage(invalidMsg))
    }
